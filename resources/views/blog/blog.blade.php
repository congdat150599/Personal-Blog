	    ...
	    @if (! $posts_blog->count())
		    <div class="col-md-8" style="margin:9rem;">
		    	 <div class="alert alert-info" style="display: flex;">
			    	<p>Nothing Found</p><i class="far fa-smile-wink" style="color:red;margin-left: .5rem; font-size: 2
		...
		<form action="{{ route('blog')}}">
			<div class="search">
				<div class="search-bar">
					<input type="text" name="search-content" value="{{ request('search-content')}}" placeholder="Search...">
		...
		<div class="popular-post">
			...
			<div class="popular-tags">
				...
				<div class="tags flex-row">
					...
					<span class="tag" data-aos="flip-up" data-aos-delay="400">illutration</span>
